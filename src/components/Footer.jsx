       ...
       <footer className="bg-gray-100 mt-16">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4 text-gray-800">About Napita</h3>
              <p className="text-gray-600">Napita is your go-to platform for booking salon appointments and discovering great beauty services near you.</p>
            </div>
            <div>
          ...
          <div className="mt-8 border-t border-gray-200 pt-8 text-center text-gray-600">
            <p>&copy; 2023 Napita. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
